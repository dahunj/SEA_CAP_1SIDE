...
BOOL CSequenceMain::AssyPicker_Run()
{
	...
	case 0:		// Cap Buffer Check
		...
		else if (m_nCapBufferCase == 10 /*&& !Check_AssyPickerFull()*/)
		{
...
BOOL CSequenceMain::UnloadStage1_Run()
{
	...
	case 10:	// 안전 확인 
		if (!m_tUnloadStage1Loop.Waiting_Time(200)) return TRUE;
...
BOOL CSequenceMain::UnloadStage2_Run()
{
	...
	case 10:	// 안전 확인 
		if (!m_tUnloadStage2Loop.Waiting_Time(200)) return TRUE;
